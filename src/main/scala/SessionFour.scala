object SessionFour extends App {
  ...
  def heightLimit(height: Double): String = {
    val rides =
      Array(
        "Rita, Galactica, The Smiler, Oblivion",
        "TH13TEEN, Spinball Whizzer, Wicker Man",
        "Marauder's Mayhem, Congo River Rapids",
        "The Blade",
        "Gangsta Granny: The Ride, Runaway Mine Train, Battle Galleons, Heave Ho, Enterprise, Raj's Bouncy Bottom Burp, Peter Rabbit Hippity Hop, Octonauts Rollercoaster Adventure, Justin's House Pie-O-Matic Factory, Go Jetters Vroomster Zoom Ride, Duel: The Haunted House Strikes Back"
      )
